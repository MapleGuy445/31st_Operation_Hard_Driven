...
_WBK_UploadTimer = [{
	...
	_text = "Transmitting: " + str (_unit getVariable "WBK_DownloadAmount") + "/ 100";
	drawIcon3D ["\a3\ui_f\data\IGUI\Cfg\holdactions\holdAction_connect_ca.paa",  [0.8, 1.0, 0.8, 0.5], _iconPosition, 1.1, 1.1, _iconAngle, _text, 0, 0.03, "PuristaLight"];
	{
